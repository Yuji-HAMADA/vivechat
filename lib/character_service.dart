...
""";
    ...
    if (response.statusCode != 200) {
      throw Exception('Failed to get emotional response: ${response.statusCode} ${response.body}');
    }
  ...
  static Future<Uint8List?> generateEmotionalImage(
    ...
    if (response.statusCode != 200) {
      throw Exception('Failed to generate emotional image: ${response.statusCode} ${response.body}');
    }
